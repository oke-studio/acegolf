...
export const landingHeroImages = [
  {
    ...
    tailwindGridPosXY:
      'col-[4/_span_1] row-[2/_span_1] md:col-[4/_span_1] md:row-[2/_span_1] lg:col-[2/_span_1] lg:row-[2/_span_1]',
  },
  {
    ...
    tailwindGridPosXY:
      'col-[3/_span_1] row-[2/_span_1] md:col-[3/_span_1] md:row-[2/_span_1]',
  },
  {
    ...
    tailwindGridPosXY:
      'col-[4/_span_1] row-[3/_span_1] md:col-[4/_span_1] md:row-[2/_span_1]',
  },
  {
    ...
    tailwindGridPosXY:
      'col-[4/_span_1] row-[1/_span_1] md:col-[4/_span_1] md:row-[1/_span_1] xl:col-[3/_span_1]',
  },

  {
    ...
    tailwindGridPosXY:
      'col-[3/_span_1] row-[1/_span_1] md:col-[4/_span_1] md:row-[1/_span_1] lg:col-[3/_span_1] lg:row-[1/_span_1] xl:col-[2/_span_1] lg:row-[1/_span_1]',
  },
]
