...
const ButtonVariantMapping: { [key in ButtonVariantType]: string } = {
  ...
  simple: '',
  nav: 'rounded-full bg-orange py-1 px-4 border-solid border-2 border-orange text-white hover:text-black transition-[color] duration-400 ease-in-out hover:bg-white',
}
