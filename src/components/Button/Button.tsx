...
const ButtonVariantMapping: { [key in ButtonVariantType]: string } = {
  ...
  navSecondary:
    'rounded-full bg-white py-1 px-4 border-solid border-solid border-2 border-black text-black hover:text-black transition-[color] duration-400 ease-in-out hover:bg-orange hover:border-black',
