...
export const VideoLandingHero = () => {
  return (
    ...
    >
      ...
      pathProps={{
        d: 'm1116.5,628H35.5c-19.57,0-35.5-15.92-35.5-35.5V35.5C0,15.93,15.93,0,35.5,0h1081c19.58,0,35.5,15.93,35.5,35.5v557c0,19.58-15.92,35.5-35.5,35.5ZM35.5,1C16.48,1,1,16.48,1,35.5v557c0,19.02,15.48,34.5,34.5,34.5h1081c19.02,0,34.5-15.48,34.5-34.5V35.5c0-19.02-15.48-34.5-34.5-34.5H35.5Z',
      }}
